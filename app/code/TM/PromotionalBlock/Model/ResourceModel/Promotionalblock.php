 ...
 */
namespace TM\PromotionalBlock\Model\ResourceModel;

class Promotionalblock extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
     * Event Manager
     * 
    ...
    {
        $this->_init('tm_promotionalblock_promotionalblock', 'promotionalblock_id');
    }

    /**
     * Retrieves Promotional Block Name from DB by passed id.
     *
     * @param string $id
     * @return string|bool
     */
    public function getPromotionalblockNameById($id)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()
            ->from($this->getMainTable(), 'name')
            ->where('promotionalblock_id = :promotionalblock_id');
        $binds = ['promotionalblock_id' => (int)$id];
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\TM\PromotionalBlock\Model\Promotionalblock $object
     * @return $this
     */
